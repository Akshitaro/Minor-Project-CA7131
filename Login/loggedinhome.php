    ...
    <div class="box-container">
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=3" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Manali</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=6" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Rajasthan</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=2" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Ladakh</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=1" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Chennai</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=8" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Kerala</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=7" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Goa</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=9" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Sikkim</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=5" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Pune</h3>
        ...
        <div class="box">
            <div class="image">
                ...
                <div class="icons">
                    <a href="../viewjourney.php?city_id=4" class="cart-btn">Visit Us</a>
                </div>
            </div>
            <div class="content">
                <h3>Mumbai</h3>
...
<section class="footer">
    ...
    <div class="credit">&copy;2024 Travelscapes Akshit Arora</div>
